...
WebSocket is different. It establishes a persistent connection between the client and server, letting either side send messages at any time, with no new request needed.
