...
```mermaid
mindmap
  	root((undefined vs. null vs. undeclared))
    	undefined
    	null
    	undeclared
...
- When initializing a variable you'll fill in later, use `null` instead of leaving it `undefined`, as the intent is clearer
