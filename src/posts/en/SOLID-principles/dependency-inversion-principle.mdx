...
The word "inversion" doesn't mean flipping the dependency. It means abstractions control the direction: high-level modules define what they need, and low-level implementations conform to those needs.
