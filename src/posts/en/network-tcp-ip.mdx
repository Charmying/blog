export const metadata = {
  ...
  date: '2026-04-09',
  excerpt: 'A practical guide to TCP/IP, covering IP addressing and packet routing, the TCP three-way handshake and reliable delivery mechanisms, TCP vs. UDP, and the four-layer model.',
  tags: ['Network'],
};
