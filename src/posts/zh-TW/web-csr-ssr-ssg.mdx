...
CSR / SSR / SSG 是 Runtime 階段的渲染策略。無論採用哪種策略，瀏覽器收到 HTML 後都要走過同樣的渲染流程，參考 [瀏覽器渲染流程](/articles/web-browser-rendering)；想了解完整執行週期，參考 [從原始碼到畫面](/articles/web-source-to-screen)。
