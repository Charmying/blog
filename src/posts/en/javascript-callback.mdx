...
This callback fires when the user clicks the button; it could fire 1 second from now, or never.
...
A callback is a function you pass into another function to be called at a specific point, either immediately or once some operation finishes.
