...
HTTP transmits everything in plain text, with no encryption of any kind. Anyone who can intercept the network traffic can read it directly, including usernames, passwords, and personal data.
