...
```text
https://example.com 請求 https://example.com/api   → 同源 ✓
https://example.com 請求 https://api.example.com   → 不同源 (子網域不同)
https://example.com 請求 http://example.com        → 不同源 (協定不同)
https://example.com 請求 https://example.com:3000  → 不同源 (埠號不同)
```
