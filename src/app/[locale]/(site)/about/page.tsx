...
const timeline: TimelineItem[] = [
  {
    ...
    orgZh: '網際威信股份有限公司',
    orgEn: 'HiTRUST.com Inc.',
    locationZh: '臺中市南屯區',
    locationEn: 'Nantun District, Taichung City, Taiwan',
  ...
  },
  {
    ...
    orgZh: '華苓科技股份有限公司',
    orgEn: 'Flowring Technology Corp.',
    locationZh: '新竹市東區',
    locationEn: 'East District, Hsinchu City, Taiwan',
  ...
  },
  {
    ...
    orgZh: '雲端數位科技有限公司',
    orgEn: 'MIXMAX Digital Technology Co., Ltd.',
    locationZh: '臺中市北屯區',
    locationEn: 'Beitun District, Taichung City, Taiwan',
    ...
    highlightsZh: [
      {
        title: "部分專案：",
        items: [
        '建準電機工業股份有限公司(越南一頁式網站)',
        '悠遊卡股份有限公司 (永續專區、投資人專區)',
        '凱薩衛浴股份有限公司 (經銷商招募)',
        '寶鋪建設、FITZONE by World Gym 、穎崴科技等上市上櫃公司',
        ],
      },
    ],
    highlightsEn: [
      {
        ...
        items: [
          "SUNONWEALTH ELECTRIC MACHINE INDUSTRY CO., LTD. (One-page website for Vietnam)",
          "EasyCard Corporation (Sustainability and Investor Relations sections)",
          "SANITAR CO., LTD. (Dealer recruitment)",
          "Listed and OTC companies including BAOPU Development, FITZONE by World Gym, and WinWay Technology Co., Ltd.",
        ],
      },
    ],
  },
...
const journey: JourneyItem[] = [
  ...
  {
    year: '2025',
    titleZh: '初探 Node.js - Express.js',
    titleEn: 'Exploring Node.js - Express.js',
