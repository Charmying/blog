...
Browser rendering is the final stage of a broader frontend pipeline. The rendering strategy — CSR, SSR, or SSG — determines what HTML the browser starts with. See [CSR vs SSR vs SSG](/articles/web-csr-ssr-ssg) for a comparison, or [From Source to Screen](/articles/web-sourcecode-to-screen) for the full lifecycle.
