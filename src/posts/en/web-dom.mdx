...
Manipulating classes is generally better than setting `style` directly, keeping styles in CSS where they belong and is easier to maintain.
...
- Listen for events with `addEventListener`, using bubbling and delegation to keep event handling efficient
