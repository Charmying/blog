...
The caller only sets the fields they care about and doesn't have to remember parameter order, which is far more readable than a long list of positional arguments.
...
- **Call super() first when inheriting**: understand the parent-then-child field initialization order
- **Don't call overridable methods**: you'll read subclass fields that aren't initialized yet
